...
public class BGAPumpkinRefreshView extends RelativeLayout {
    ...
    public BGAPumpkinRefreshView(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
    ...
    protected void onFinishInflate() {
        ...
        mPullDownView = (ImageView) findViewById(R.id.iv_pumpkin_pull_down);
        mReleaseRefreshingView = (ImageView) findViewById(R.id.iv_pumpkin_release_refreshing);
    }
    ...
    public void changeToFootRefreshing() {
        stopChangeToReleaseRefreshAd();
